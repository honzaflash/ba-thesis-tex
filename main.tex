...
\begin{itemize}[--]
    ...
    a spinning explosion animation next few frames, and then a position reset followed by
    ...
    We use this predifined instance: \inlinehs{instance Monoid a => Applicative ((,) a)},
    where a is our \inlinehs{WorldEvents} package.}
...
\begin{itemize}[--]
    ...
    causes the ship to either loose a life, and set the state to \inlinehs{Exploding}
...
% John Carmack said in his keynote at Quakecon 2013\cite{carmackkeynote}
% that he chose Haskell to explore functional programming because of its \say{brutal} functional purity.
% He talked about how being a technical director over millions of lines of code,
...
\say{combining the indulgences of impurity with the blessings of purity} %\cite{wadlermonads}
